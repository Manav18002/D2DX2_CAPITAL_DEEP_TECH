...
export function Footer() {
  ...
  return (
    <footer className="relative bg-gray-950 dark:bg-black border-t border-gray-800 dark:border-gray-900">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-14">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-3 mb-5">
              ...
              <div>
                <h3 className="text-lg font-bold text-white tracking-tight">D2DX2 Capital</h3>
                <p className="text-[11px] text-blue-400 font-semibold uppercase tracking-widest">Venture Platform</p>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 bg-gray-900 dark:bg-gray-800 border border-gray-800 dark:border-gray-700 rounded-xl flex items-center justify-center hover:bg-blue-600 hover:border-blue-500 transition-all duration-300 group"
              ...
              {links.map((link) => (
                <li key={link.id}>
                  <button
                    ...
                    className="text-gray-400 hover:text-blue-400 transition-colors text-sm group flex items-center"
                  >
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 bg-gray-900 dark:bg-gray-800 border border-gray-800 dark:border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
                />
                <motion.button
                  type="submit"
                  disabled={isLoading}
